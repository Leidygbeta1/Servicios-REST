...
public class ServicioPersistenciaMock implements IServicioPersistenciaMockRemote, IServicioPersistenciaMockLocal {
        ...
        // Validar que no exista un usuario con el mismo login
            for (Usuario us : usuarios) {
                if (us.getLogin().equals(usuario.getLogin())) {
                    throw new OperacionInvalidaException("El usuario ya está registrado");
                }
            }
    ...
    public void delete(Object obj) throws OperacionInvalidaException
    {
        ...
        else if (obj instanceof Usuario)
        {
            ...
            // Verifica si el usuario ha realizado compras antes de eliminarlo
            ...
            // Ahora, eliminamos el usuario si existe en la lista
            if (usuarioABorrar != null && usuarioABorrar.getLogin() != null)
            {
                usuarios.removeIf(ven -> ven.getLogin().equals(usuarioABorrar.getLogin()));
                System.out.print("Usuario borrado correctamente");
            }
        }
    }
    ...
    public Object findById(Class c, Object id)
    {
        ...
        else  if (c.equals(Usuario.class))
        {
            ...
            {
                if (usuario.getLogin().equals(id.toString()))
                {
                    return usuario;
                }
            }
